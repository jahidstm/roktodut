            ...
            <section id="nid-security" class="mb-10 scroll-mt-20">
                ...
                <div class="prose-custom">
                    ...
                    <ul>
                        ...
                        <li>প্রতিটি NID view ইভেন্ট audit log-এ সংরক্ষিত হয়</li>
                        <li>রিটেনশন পলিসি শেষ হলে NID ফাইল/নাম্বার স্বয়ংক্রিয়ভাবে purge করা হয়</li>
                        <li>ভেরিফিকেশন সম্পন্ন হলে ডোনার অনুরোধ করলে ডকুমেন্ট আগেই মুছে ফেলা যাবে</li>
                        <li>ডিফল্ট রিটেনশন উইন্ডো: সর্বোচ্চ ৩৬৫ দিন (প্ল্যাটফর্ম পলিসি অনুযায়ী কনফিগারযোগ্য)</li>
