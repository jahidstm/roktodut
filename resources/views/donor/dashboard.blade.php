       ...
       data-scroll-reveal>
        ...
        <div class="flex items-center gap-5 relative z-10 w-full sm:w-auto">
            ...
            <div>
                ...
                <p class="text-slate-400 text-sm font-medium mt-1">হিমোগ্লোবিন, ব্লাড প্রেশার ট্র্যাক করুন — AI গাইডলাইন পাবেন।</p>
            </div>
        </div>
            ...
            <table class="w-full text-left">
                <thead>
                    <tr class="bg-slate-50 border-b border-slate-100 text-xs uppercase tracking-wider font-bold text-slate-500">
                        ...
                        <th class="px-6 py-4">রেফারেন্স</th>
                ...
                <tbody class="divide-y divide-slate-100 text-sm">
                    ...
                    <tr>
                        <td colspan="4" class="px-6 py-12 text-center">
                            ...
                            <p class="text-xs text-slate-500 mt-1">প্রথম রক্তদানের পর এখানে দেখা যাবে।</p>
                        </td>
                    </tr>
                    @endforelse
                </tbody>
