        ...
        <div class="p-6 sm:p-8 border-b border-slate-100 bg-slate-50/50">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-5">
                ...
                <div>
                    ...
                    <div class="relative">
                        <input type="number" name="cadence_days" value="{{ old('cadence_days', 30) }}" min="14" max="90" required class="w-full border-slate-200 rounded-xl focus:ring-blue-500 focus:border-blue-500 shadow-sm pr-12">
                ...
                <div>
                    ...
                    <div class="relative">
                        <input type="number" name="lead_time_days" value="{{ old('lead_time_days', 3) }}" min="1" max="7" required class="w-full border-slate-200 rounded-xl focus:ring-blue-500 focus:border-blue-500 shadow-sm pr-12">
                        <div class="absolute inset-y-0 right-0 pr-3 flex items-center pointer-events-none">
                            <span class="text-sm font-bold text-slate-400">দিন</span>
                        </div>
                    </div>
                    <p class="text-[10px] text-slate-500 mt-1">রক্ত লাগার কত দিন আগে অটো-রিকোয়েস্ট তৈরি হবে।</p>
                </div>
            </div>
        </div>
