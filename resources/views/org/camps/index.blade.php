...
@section('content')
<div data-panel-id="camps">

    <div class="bg-white rounded-2xl border border-slate-200 shadow-sm overflow-hidden mb-8 scroll-reveal" data-scroll-reveal>
            ...
            <table class="w-full text-left border-collapse">
                <thead>
                    <tr class="bg-slate-50 text-slate-500 text-xs uppercase tracking-widest font-black">
                        ...
                        <th class="px-6 py-4 border-b border-slate-100">তারিখ ও সময়</th>
                    ...
                    @empty
                        <tr>
                            <td colspan="6" class="px-6 py-12 text-center bg-slate-50">
                                ...
                                <h3 class="text-slate-800 font-extrabold">এখনও কোনো ক্যাম্প তৈরি করা হয়নি</h3>
