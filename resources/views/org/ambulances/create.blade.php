...
<div>
    ...
    <div class="mb-6 flex items-center gap-3">
        <a href="{{ route('org.ambulances.index') }}" class="p-2 bg-white border border-slate-200 rounded-lg hover:bg-slate-50 transition text-slate-500">
            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M10 19l-7-7m0 0l7-7m-7 7h18"></path></svg>
        </a>
        <div>
            <h1 class="text-2xl font-black text-slate-900 tracking-tight">নতুন অ্যাম্বুলেন্স যোগ করুন</h1>
            <p class="text-slate-500 font-medium text-sm">পাবলিক ডিরেক্টরিতে সরাসরি ভেরিফাইড হিসেবে যুক্ত হবে।</p>
        </div>
    </div>
        ...
        <div class="bg-white overflow-hidden shadow-sm sm:rounded-[2rem] border border-slate-100 p-8 sm:p-10">
            <form action="{{ route('org.ambulances.store') }}" method="POST" x-data="{
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div class="md:col-span-2 border-t border-slate-100 pt-6 mt-2">
                        <x-input-label for="vehicle_number" value="গাড়ির রেজিস্ট্রেশন নম্বর (ঐচ্ছিক)" class="text-slate-700 font-bold" />
