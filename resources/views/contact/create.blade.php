...
.cf-label  { @apply block text-sm font-bold text-slate-700 mb-1.5; }
.cf-input  {
    @apply block w-full rounded-xl border border-slate-200 bg-slate-50 px-4 py-2.5
           text-sm text-slate-800 placeholder-slate-400 font-medium
           focus:outline-none focus:ring-2 focus:ring-red-500 focus:border-red-400 focus:bg-white
           transition-all duration-150;
}
.cf-error  { @apply border-red-300 bg-red-50 focus:ring-red-400 focus:border-red-400; }
.cf-errmsg {
    @apply mt-1 text-xs font-semibold text-red-600;
}
.cf-errmsg::before { content: '⚠ '; }
</style>
@endpush
