...
<footer class="bg-slate-950">
    ...
    <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 pt-12 lg:pt-16 pb-10 lg:pb-12">
        <div class="flex flex-col lg:grid lg:grid-cols-4 gap-12 lg:gap-16 xl:gap-20">
            ...
            <div class="lg:col-span-3 grid grid-cols-2 sm:grid-cols-3 gap-x-8 gap-y-12 lg:gap-12 xl:gap-20">
