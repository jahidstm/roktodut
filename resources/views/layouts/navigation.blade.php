        ...
        <div class="flex justify-between h-16">
            ...
            <div class="hidden sm:flex sm:items-center sm:ms-6">
                ...
                <div class="relative me-4" x-data="{ dropdownOpen: false }" @click.outside="dropdownOpen = false" @close.stop="dropdownOpen = false">
                    <button @click="dropdownOpen = ! dropdownOpen" class="relative p-2 text-gray-500 hover:text-gray-700 transition rounded-full hover:bg-gray-100 focus:outline-none">
