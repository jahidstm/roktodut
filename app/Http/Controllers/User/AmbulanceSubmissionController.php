...
class AmbulanceSubmissionController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('ambulances.index')
            ->with('success', 'ধন্যবাদ! আপনার সাবমিট করা অ্যাম্বুলেন্সটি রিভিউয়ের জন্য অ্যাডমিন প্যানেলে পাঠানো হয়েছে। ভেরিফাই হওয়ার পর এটি ডিরেক্টরিতে যুক্ত হবে এবং আপনি গ্যামিফিকেশন পয়েন্ট পাবেন।');
    }
}
